...
public class ManyFunctions
{
     ...
     */
    public static boolean isVowelIgnoreCase(char letter)
    { 
    ...
    public static boolean isConsonantIgnoreCase(char letter)
    {
       
        return !isVowelIgnoreCase(letter);
    }
